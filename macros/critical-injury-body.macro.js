// Foundry Macro: Critical Injury - Body
...
(async () => {
  ...
  try {
    ...
    const injury = CRITICAL_INJURIES_BODY[total] || {
      name: "Unknown Injury",
    ...
    console.error("long-drift | Critical Injury - Body macro failed", err);
    ui.notifications.error(`Critical Injury - Body macro failed: ${err.message ?? err}`);
  }
})();
